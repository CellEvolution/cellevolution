...
function [Vn,NormalVecX,NormalVecY,nSn,nSn_ave,Ux,Uy,Vx,Vy,tp1,tp2,sigma11,sigma22,sigma12] = ...
         RadialModelTwo_NormalStressV6CORRECTEDoffsetsigma(X,Y,Phi0,Phi,U,V,p,mu,lmd,theta,beta,zz,zz1,eee,offset,lambda,K,gamma,resist,expN,Hev,Del,Xbart,Ybart)
%% parameter
...
%Vm       = -beta*sign(delta_f) + lambda.*(1-area_ratio);
